...
namespace pro.Controllers
{
    public class ChefsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Nationality")] Chef chef)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Nationality")] Chef chef)
        {
            if (id != chef.Id)
            {
                return NotFound();
